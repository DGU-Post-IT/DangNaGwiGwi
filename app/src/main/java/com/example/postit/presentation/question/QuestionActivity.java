...
public class QuestionActivity extends AppCompatActivity {
    ...
    void saveEmotionRecordOnDataBase(int emotion){
        ...
        MediaPlayer player2 = MediaPlayer.create(this, R.raw.good_bye);
...
//            ct.start();
    ...
    private void showEmotionDialog() {
        ...
        MediaPlayer player_feeling_check = MediaPlayer.create(this, R.raw.emotion_check);
        player_feeling_check.start();
        //binding.tvInfo2.setVisibility(View.GONE);
